...
export const CASES: CaseStudy[] = [
  {
    ...
    title: "내 정산 로직이 195만원을 틀렸다",
    period: "2025.06 — 2025.12 · 시드 데이터 25주치 · 브랜드 4곳",
    stakes:
      "실사용자는 없었다. 브랜드 4곳과 25주치 거래는 내가 넣은 시드 데이터다. 틀린 건 숫자가 아니라 로직이었고, 그건 실제 정산에 올렸다면 그대로 틀렸을 로직이다.",
    sections: [
      {
        h: "증상",
        p:
          "37주차 Loar 정산에 이미 취소된 21만원 주문이 들어가 있었다. 시드 데이터라 정답을 알고 " +
          "있었기 때문에 눈에 띄었다. 한 건이면 입력 실수지만, " +
